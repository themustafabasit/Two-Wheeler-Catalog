            ...
            <table style="width:100%;">
                ...
                <tr>
                    <td colspan="6" style="text-align: center">
                        <asp:Label ID="Label15" runat="server" Text="Dealer Registration" CssClass="lblh"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style6" style="width: 465px">&nbsp;</td>
                ...
                <tr>
                    ...
                    <td class="auto-style4" style="width: 127px">
                        <asp:Label ID="Label1" runat="server" Text="Email ID " CssClass="lblaside"></asp:Label>
                    </td>
            ...
            <table style="width:100%;">
                ...
                <tr>
                    ...
                    <td class="auto-style51" style="text-align: right; width: 173px;">
                        <asp:Button ID="Button3" runat="server" CausesValidation="False" OnClick="Button3_Click" Text="Cancel" CssClass="bt" />
                    </td>
                    <td class="auto-style50" style="text-align: right; width: 144px;">
                        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Next" CssClass="bt" />
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
        ...
        <asp:View ID="View2" runat="server">
            ...
            <table style="width:100%;">
                ...
                <tr>
                    <td class="auto-style67" style="width: 440px"></td>
                    <td class="auto-style66" style="width: 130px">
                        <asp:Label ID="Label2" runat="server" Text="Enter OTP" CssClass="lblaside"></asp:Label>
                    </td>
            ...
            <table style="width:100%;">
                ...
                <tr>
                    ...
                    <td class="auto-style38" style="text-align: right; width: 171px;">
                        <asp:Button ID="Button5" runat="server" CausesValidation="False" OnClick="Button5_Click" Text="Cancel" CssClass="bt" />
                    </td>
                    <td class="auto-style35" style="text-align: right; width: 117px;">
                        <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Next" CssClass="bt" />
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
            ...
            <table style="width:100%;">
                ...
                <tr>
                    ...
                    <td class="auto-style74">
                        <asp:Label ID="Label17" runat="server" Text="I don't recieve otp " CssClass="lblaside"></asp:Label>
                        <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click" CausesValidation="False" CssClass="lkbt">resend me code again</asp:LinkButton>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                 ...
                 <table style="width:100%;">
                     ...
                     <tr>
                         <td class="auto-style72" colspan="5" style="text-align: center;">
                             <asp:Label ID="Label24" runat="server" CssClass="lblh" Text="Dealer Details"></asp:Label>
                         </td>
                     </tr>
                     <tr>
                         <td class="auto-style72" style="width: 351px">&nbsp;</td>
                     ...
                     <tr>
                         ...
                         <td class="auto-style71" style="width: 136px">
                             <asp:Label ID="Label19" runat="server" Text="Seller Name" CssClass="lblaside"></asp:Label>
                         </td>
                         <td style="text-align: right; width: 334px;" class="auto-style70">
                             <asp:TextBox ID="txtsname" runat="server" CssClass="txtn"></asp:TextBox>
                         </td>
                     ...
                     <tr>
                         <td class="auto-style72" style="width: 351px"></td>
                         <td class="auto-style71" style="width: 136px">
                             <asp:Label ID="Label3" runat="server" Text="Name" CssClass="lblaside"></asp:Label>
                         </td>
                 ...
                 <table style="width:100%;">
                     ...
                     <tr>
                         ...
                         <td class="auto-style53" style="text-align: right; width: 130px;">
                             <asp:Button ID="Button6" runat="server" OnClick="Button6_Click" Text="Cancel" CausesValidation="False" CssClass="bt" />
                         </td>
                         <td class="auto-style52" style="text-align: right; width: 157px;">
                             <asp:Button ID="Button7" runat="server" OnClick="Button7_Click" Text="Next" CssClass="bt" />
                         </td>
                         <td>&nbsp;</td>
                     </tr>
                     <tr>
            ...
            <table style="width:100%;">
                ...
                <tr>
                    <td colspan="4" style="text-align: center">
                        <asp:Label ID="Label20" runat="server" Text="provide details  about what  you  are going to sell here" CssClass="lblh"></asp:Label>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="height: 21px; width: 107px">
                        <asp:Label ID="Label21" runat="server" Text="Type" CssClass="lblaside"></asp:Label>
                    </td>
                    <td style="height: 21px; text-align: right; width: 191px">
                        <asp:DropDownList ID="ddltype" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddltype_SelectedIndexChanged" CssClass="slm">
                        </asp:DropDownList>
                    </td>
                    <td style="height: 21px"></td>
                </tr>
                                ...
                                <table style="width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 299px">
                                            <asp:Label ID="lblbrandfor" runat="server" Text="Brands For" CssClass="lblh"></asp:Label>
                                        </td>
                                        <td style="width: 188px">&nbsp;</td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td style="width: 443px">&nbsp;</td>
                                        <td style="width: 299px">
                                            <asp:CheckBox ID="chkselectallbieksorscooties" runat="server" AutoPostBack="True" OnCheckedChanged="CheckBox4_CheckedChanged" Text="select all" CssClass="lblaside" />
                                        </td>
                                        <td style="width: 188px">&nbsp;</td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td style="width: 443px">&nbsp;</td>
                                        <td style="width: 299px">
                                            <asp:CheckBoxList ID="chkbrand" runat="server" CssClass="lblaside">
                                            </asp:CheckBoxList>
                                        </td>
                                        <td style="width: 188px">&nbsp;</td>
                                        <td>&nbsp;</td>
                                ...
                                <table style="width:100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="height: 21px; width: 248px;">
                                            <div>
                                            <asp:Label ID="Label22" runat="server" Text="Brands For Bikes" CssClass="lblh"></asp:Label>
                                                <br /><br />
                                                <asp:CheckBox ID="chkselectallbikes" runat="server" Text="select all" AutoPostBack="True" OnCheckedChanged="chkselectallbikes_CheckedChanged" CssClass="lblaside" />
                                            <br /><br />
                                                <asp:CheckBoxList ID="chkbikes" runat="server" OnSelectedIndexChanged="chkbikes_SelectedIndexChanged" CssClass="lblaside">
                                            </asp:CheckBoxList>
                                        </div>
                                                </td>
                                        <td style="height: 21px; width: 295px;">
                                            <div style="height:100%;">
                                            <asp:Label ID="Label23" runat="server" Text="Brands For Scooties" CssClass="lblh"></asp:Label>
                                                <br /><br />
                                            <asp:CheckBox ID="chkselectallscooties" runat="server" Text="select all" AutoPostBack="True" OnCheckedChanged="chkselectallscooties_CheckedChanged" CssClass="lblaside" />
                                                <br /><br />
                                            <asp:CheckBoxList ID="chkscooties" runat="server" CssClass="lblaside">
                                            </asp:CheckBoxList>
                                                </div>
                                        </td>
                                        <td style="height: 21px"></td>
            ...
            <table style="width: 100%">
                            ...
                            <tr>
                                ...
                                <td style="text-align: right; width: 135px">
                                    <asp:Button ID="Button10" runat="server" OnClick="Button9_Click" Text="Leave" CssClass="bt" />
                                </td>
                                <td style="text-align: right; width: 151px">
                                    <asp:Button ID="btregister" runat="server" OnClick="Button8_Click" Text="Register" CssClass="bt" />
                                </td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>
             ...
             <table style="width: 100%;">
                ...
                <tr>
                    ...
                    <td style="text-align: center">
                        <asp:Label ID="Label18" runat="server" Text="Your username and password has been sent to your registered email address. To login  click  " CssClass="lblaside"></asp:Label>
                        <asp:LinkButton ID="LinkButton3" runat="server" OnClick="LinkButton3_Click" CssClass="lkbt">here</asp:LinkButton>
                    </td>
                    <td>&nbsp;</td>
                </tr>
            </table>
