...
public partial class AdminModule_Default : System.Web.UI.Page
{
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
       ...
       MailMessage ma = new MailMessage("mailtobaist74@gmail.com", Session["d_email"].ToString(), "Account username and password", "Dear, " + Session["d_name"].ToString() + " congratulations you are sucessfully registered as a new user <br /> Your user name is : " + Session["d_email"].ToString() + "<br />password is : " + psw); 
        ma.IsBodyHtml = true;
