         ...
         <asp:MultiView ID="MultiView1" runat="server">
                ...
                <table style="width:100%;">
                    ...
                    <tr>
                        <td colspan="6" style="text-align: center">
                            <asp:Label ID="Label19" runat="server" CssClass="lblh" Text="Product Description"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 464px">&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right; width: 250px">
                            <asp:TextBox ID="txtpname" runat="server" cssclass="txtn"></asp:TextBox>
                        </td>
                        <td style="width: 27px">&nbsp;</td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right; width: 250px">
                            <asp:TextBox ID="txtprice" runat="server" cssclass="txtn"></asp:TextBox>
                        </td>
                        <td style="width: 27px">&nbsp;</td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right; width: 250px">
                            <asp:DropDownList ID="ddltype" runat="server" AutoPostBack="True" CssClass="sls" OnSelectedIndexChanged="ddltype_SelectedIndexChanged">
                            </asp:DropDownList>
                        </td>
                        <td style="width: 27px">&nbsp;</td>
                        <td>&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right; width: 250px">
                            <asp:DropDownList ID="ddlbrand" runat="server" CssClass="sls">
                            </asp:DropDownList>
                        </td>
                        <td style="width: 27px">&nbsp;</td>
                        <td>&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right; width: 250px">
                            <asp:TextBox ID="txtsdesc" runat="server" cssclass="txtn"></asp:TextBox>
                        </td>
                        <td style="width: 27px">&nbsp;</td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right; width: 250px">
                            <asp:TextBox ID="txtldesc" runat="server" cssclass="txtn"></asp:TextBox>
                        </td>
                        <td style="width: 27px">&nbsp;</td>
                        <td>
                ...
                <table style="width:100%;">
                    ...
                    <tr>
                        ...
                        <td style="width: 259px; text-align: right;">
                            <asp:Button ID="Button1" runat="server" Text="Cancel"     CssClass="bt"  CausesValidation="False"    />
                        </td>
                        <td style="width: 161px; text-align: right;">
                            <asp:Button ID="Button2" runat="server" OnClick="Button2_Click"  CssClass="bt"     Text  ="Next" />
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
            ...
            <asp:View ID="View2" runat="server">
                <table style="width:100%;">
                    ...
                    <tr>
                        <td colspan="6" style="text-align: center">
                            <asp:Label ID="Label15" runat="server" CssClass="lblh" Text="Product Specification"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 476px">&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right; width: 276px">
                            <asp:TextBox ID="txtcolor" runat="server" CssClass="txtn"></asp:TextBox>
                        </td>
                        <td style="width: 35px">&nbsp;</td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right; width: 276px">
                            <asp:TextBox ID="txtmileage" runat="server" CssClass="txtn"></asp:TextBox>
                        </td>
                        <td style="width: 35px">&nbsp;</td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right; width: 276px">
                            <asp:TextBox ID="txtbhp" runat="server" CssClass="txtn"></asp:TextBox>
                        </td>
                        <td style="width: 35px">&nbsp;</td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right; width: 276px">
                            <asp:DropDownList ID="ddltyres" runat="server" CssClass="sls">
                    ...
                    <tr>
                        ...
                        <td style="text-align: right; width: 276px">
                            <asp:DropDownList ID="ddlbrakes" runat="server" CssClass="sls">
                    ...
                    <tr>
                        ...
                        <td style="text-align: right; width: 276px">
                            <asp:TextBox ID="txtfueltank" runat="server" CssClass="txtn"></asp:TextBox>
                        </td>
                        <td style="width: 35px">&nbsp;</td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right; width: 276px">
                            <asp:TextBox ID="txttopspeed" runat="server" CssClass="txtn"></asp:TextBox>
                        </td>
                        <td style="width: 35px">&nbsp;</td>
                        <td>
                ...
                <table style="width:100%;">
                    ...
                    <tr>
                        ...
                        <td style="width: 156px">
                            <asp:Button ID="Button3" runat="server" CausesValidation="False" CssClass="bt" Text="cancel" />
                        </td>
                        <td style="width: 140px">
                            <asp:Button ID="Button4" runat="server" CssClass="bt" OnClick="Button4_Click" Text="Next" />
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
            ...
            <asp:View ID="View3" runat="server">
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td colspan="6" style="text-align: center;">
                            <asp:Label ID="Label20" runat="server" CssClass="lblh" Text="product image and Stock"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 483px">&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td style="width: 113px">
                            <asp:Label ID="Label18" runat="server" CssClass="lblaside" Text="Quantity"></asp:Label>
                        </td>
                        <td style="width: 279px; text-align: right;">
                            <asp:TextBox ID="Txtquantity" runat="server" CssClass="txtn"></asp:TextBox>
                        </td>
                        <td style="width: 39px">&nbsp;</td>
                        <td>
                    ...
                    <tr>
                        <td style="width: 483px">&nbsp;</td>
                        <td style="width: 113px">
                            <asp:Label ID="Label21" runat="server" CssClass="lblaside" Text="product image"></asp:Label>
                        </td>
                        <td style="width: 279px; text-align: right;">
                ...
                <table style="width:100%;">
                    ...
                    <tr>
                        ...
                        <td style="width: 147px">
                            <asp:Button ID="Button5" runat="server" CssClass="bt" Text="Cancel" />
                        </td>
                        <td style="width: 147px">
                            <asp:Button ID="Button6" runat="server" CssClass="bt" OnClick="Button6_Click" Text="Submit" />
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
            ...
            <asp:View ID="View4" runat="server">
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td style="width: 452px">&nbsp;</td>
                        <td>
                            <asp:Label ID="Label16" runat="server" CssClass="lblaside" Text="Your Product Has Been Successfully Added.to upload more product  images click "></asp:Label>
                            &nbsp;<asp:LinkButton ID="LinkButton2" runat="server" CssClass="lkbt" OnClick="LinkButton1_Click">Here..</asp:LinkButton>
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        <td style="width: 452px">&nbsp;</td>
                        <td>
                            <asp:Label ID="Label17" runat="server" Text="Go To Home Page click" CssClass="lblaside"></asp:Label>&nbsp;<asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click" CssClass="lkbt">Here..</asp:LinkButton>
                        </td>
                        <td>
                            &nbsp;</td>
                    </tr>
