    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        if (FileUpload1.HasFile)
        {
            ...
            if (extension.ToLower() == ".png" || extension.ToLower() == ".jpg" || extension.ToLower() == "jpeg" || extension.ToLower() == "bmp" || extension.ToLower() == ".tiff")
            {
                ...
                obj.exe_Command(str);
                FileUpload1.SaveAs(Server.MapPath("../DealerModule/p_images/" + image_name));
                Session["check"] = "false";
            }
        }
        if (FileUpload2.HasFile)
        {
            ...
            if (extension.ToLower() == ".png" || extension.ToLower() == ".jpg" || extension.ToLower() == "jpeg" || extension.ToLower() == "bmp" || extension.ToLower() == ".tiff")
            {
                ...
                connectionclass obj = new connectionclass();
                obj.exe_Command(str);
                FileUpload2.SaveAs(Server.MapPath("../DealerModule/p_images/" + image_name));
                Session["check"] = "false";
            }
        }
        if (FileUpload3.HasFile)
        {
            ...
            if (extension.ToLower() == ".png" || extension.ToLower() == ".jpg" || extension.ToLower() == "jpeg" || extension.ToLower() == "bmp" || extension.ToLower() == ".tiff")
            {
                ...
                connectionclass obj = new connectionclass();
                obj.exe_Command(str);
                FileUpload3.SaveAs(Server.MapPath("../DealerModule/p_images/" + image_name));
                Session["check"] = "false";
            }
        }
        if (FileUpload4.HasFile)
        {
            ...
            if (extension.ToLower() == ".png" || extension.ToLower() == ".jpg" || extension.ToLower() == "jpeg" || extension.ToLower() == "bmp" || extension.ToLower() == ".tiff")
            {
                ...
                connectionclass obj = new connectionclass();
                obj.exe_Command(str);
                FileUpload4.SaveAs(Server.MapPath("../DealerModule/p_images/" + image_name));
                Session["check"] = "false";
            }
        }
