                ...
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td colspan="3" style="text-align: center">
                            <asp:Label ID="Label2" runat="server" CssClass="lblh" Text="remove product"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
            ...
            <asp:View ID="View2" runat="server">
                ...
                <table style="width:100%;">
                    ...
                    <tr>
                        <td style="width: 686px">&nbsp;</td>
                        <td style="width: 91px">
                            <asp:Button ID="Button2" runat="server" CssClass="bt" OnClick="Button2_Click" Text="select another" />
                        </td>
                        <td style="width: 118px">
                            &nbsp;</td>
                        <td>
                            <asp:Button ID="Button3" runat="server" CssClass="bt" OnClick="Button3_Click" Text="De-Link" />
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 686px">&nbsp;</td>
