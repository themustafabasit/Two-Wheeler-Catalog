             ...
             <table style="width: 100%;">
                ...
                <tr>
                    <td style="height: 21px; text-align: center;" colspan="3">
                        <asp:Label ID="Label18" runat="server" CssClass="lblaside" Text="Your username and password will be sent to you  via your  registered email address, after admin aproves your request .goto  home page click  "></asp:Label>
