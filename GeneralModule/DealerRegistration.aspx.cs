...
public partial class GeneralModule_DRegistration : System.Web.UI.Page
{
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        ...
        n = r.Next(1000, 10000);
        ViewState["otp"] = n.ToString();
        MailMessage m = new MailMessage("mailtobaist74@gmail.com", txtemailid.Text, "OTP", "hi dealer your new otp is :  " + n.ToString());
        m.IsBodyHtml = true;
        SmtpClient sc = new SmtpClient();
        sc.EnableSsl = true;
        sc.Port = 587;
    ...
    protected void Button4_Click(object sender, EventArgs e)
    {
        ...
        if (FileUpload1.HasFile)
        {
            ...
            if (extension.ToLower() == ".png" || extension.ToLower() == ".jpg" || extension.ToLower() == "jpeg" || extension.ToLower() == "bmp" || extension.ToLower() == ".tiff")
            {
                ...
                FileUpload1.SaveAs(Server.MapPath("../DealerModule/dp/" + FileUpload1.FileName));
        ...
        if (FileUpload1.HasFile)
        {
            ...
            if (extension.ToLower() == ".png" || extension.ToLower() == ".jpg" || extension.ToLower() == "jpeg" || extension.ToLower() == "bmp" || extension.ToLower() == ".tiff")
            {
                ...
                if (obj.dr.HasRows)
                {
                    ...
                    obj.exe_Command(str);
                    FileUpload1.SaveAs(Server.MapPath("../DealerModule/dp/" + dp_name));
    ...
    protected void Button8_Click(object sender, EventArgs e)
    {
        ...
        if (obj.dr.HasRows)
        {
           ...
           if (ddltype.SelectedItem.ToString() == "Bikes" || ddltype.SelectedItem.ToString() == "Scooties")
           {
               // insert type
